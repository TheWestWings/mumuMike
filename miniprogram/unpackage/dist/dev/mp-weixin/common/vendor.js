...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_DARK_MODE":"false","VUE_APP_NAME":"mumu-order","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/* 26 */
/*!****************************************************************!*\
  !*** /Users/west/Desktop/Java/mumuMike/miniprogram/pages.json ***!
  \****************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* 33 */
/*!********************************************************************!*\
  !*** /Users/west/Desktop/Java/mumuMike/miniprogram/store/index.js ***!
  \********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var store = new _vuex.default.Store({
  ...
  mutations: {
    ...
    SET_TABLE_ID: function SET_TABLE_ID(state, tableId) {
    ...
    ADD_TO_CART: function ADD_TO_CART(state, product) {
      ...
      var existing = state.cart.find(function (item) {
        return item.id === product.id && item.spec === product.spec;
      });
      if (existing) {
    ...
    REMOVE_FROM_CART: function REMOVE_FROM_CART(state, _ref) {
      var id = _ref.id,
        spec = _ref.spec;
      var index = state.cart.findIndex(function (item) {
        return item.id === id && item.spec === spec;
      });
      if (index !== -1) {
    ...
    UPDATE_CART_COUNT: function UPDATE_CART_COUNT(state, _ref2) {
      var id = _ref2.id,
        spec = _ref2.spec,
        count = _ref2.count;
...
/* 52 */
/*!******************************************************************!*\
  !*** /Users/west/Desktop/Java/mumuMike/miniprogram/api/index.js ***!
  \******************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.register = exports.login = exports.getProductVOList = exports.getProductList = exports.getProductById = exports.getOrderList = exports.getOrderById = exports.createOrder = exports.createFeedback = void 0;
var _request = _interopRequireDefault(__webpack_require__(/*! @/utils/request */ 53));
...
var getProductList = function getProductList(data) {
  return (0, _request.default)({
...
var getProductVOList = function getProductVOList() {
  return (0, _request.default)({
    url: '/product/getProductVOList',
    method: 'GET'
  });
}; // Assuming this exists based on web code
exports.getProductVOList = getProductVOList;
...
var getOrderById = function getOrderById(id) {
  return (0, _request.default)({
    url: "/order/getOrderVOById/".concat(id),
    method: 'GET'
  });
};
...
/* 53 */
/*!**********************************************************************!*\
  !*** /Users/west/Desktop/Java/mumuMike/miniprogram/utils/request.js ***!
  \**********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); enumerableOnly && (symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; })), keys.push.apply(keys, symbols); } return keys; }
function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = null != arguments[i] ? arguments[i] : {}; i % 2 ? ownKeys(Object(source), !0).forEach(function (key) { (0, _defineProperty2.default)(target, key, source[key]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)) : ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } return target; }
var BASE_URL = 'http://localhost:8080'; // Change to your actual backend IP if testing on device
